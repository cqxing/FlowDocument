...
public class EnterpriseCenterFragment extends Fragment {
    ...
    public static EnterpriseCenterFragment newInstance() {
        EnterpriseCenterFragment fragment = new EnterpriseCenterFragment();
        return fragment;
    }

    public static EnterpriseCenterFragment newInstance(String param1, String param2) {
        EnterpriseCenterFragment fragment = new EnterpriseCenterFragment();
